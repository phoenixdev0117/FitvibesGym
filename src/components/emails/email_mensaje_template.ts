export function mensajeContactoCliente(
  nombre: string,
  email: string,
  mensaje: string,
  telefono: string
          ...
          <td>
            ...
            <table align="center" width="100%" border="0" cellPadding="0" cellSpacing="0" role="presentation" style="padding:20px 74px;text-align:center;">
              <tbody>
                <tr>
                  <td> 
                    <p style="font-size:14px;line-height:2;margin:0;color:#747474;font-weight:500">Gracias por comunicarte.</p>
                    <p style="font-size:14px;line-height:2;margin:0;color:#747474;font-weight:500;margin-top:24px">Te responderemos a la brevedad.</p>
                  </td>
                </tr>
              </tbody>
            </table>
            ...
            <table align="center" width="100%" border="0" cellPadding="0" cellSpacing="0" role="presentation" style="padding-left:40px;padding-right:40px;padding-top:22px;padding-bottom:22px">
              <tbody>
                <tr>
                  <td>
                    <p style="font-size:18px;line-height:2;margin:0;font-weight:bold">Has enviado el siguiente mensaje:</p>
                    ...
                    <p style="font-size:14px;line-height:2;margin:0;color:#747474;font-weight:500">Telefono: ${telefono}</p>
                    <p style="display:flex;font-size:14px;line-height:2;margin:0;color:#747474;font-weight:500;line-height:1.2;text-align:jusify">Mensaje: ${mensaje}</p>
                  </td>
