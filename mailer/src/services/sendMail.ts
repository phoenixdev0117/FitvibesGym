...
// send mail
const sendEmail = async (to: string, date :string, classNum:string, seatsList:string) => {
    ...
    const res = await transporter.sendMail({
      ...
      <tr>
        <td style="padding: 0 60px; font-size: 32px; font-family: 'Trebuchet MS', 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Arial, sans-serif;">
          ...
          <p><strong style="color:#c60384; font-family: Georgia, 'Times New Roman', Times, serif; font-size: 36px;">FECHA:</strong> ${date}</p>
          <p><strong style="color:#c60384; font-family: Georgia, 'Times New Roman', Times, serif; font-size: 36px;">HORA:</strong> ${classNum}</p>
          <p><strong style="color:#c60384; font-family: Georgia, 'Times New Roman', Times, serif; font-size: 36px;">BICICLETA:</strong> ${seatsList}</p>
